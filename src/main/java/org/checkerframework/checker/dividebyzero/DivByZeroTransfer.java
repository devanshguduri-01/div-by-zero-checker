...
public class DivByZeroTransfer extends CFTransfer {
    ...
    private AnnotationMirror arithmeticTransfer(
        ...
        case MINUS:
            ...
            if (isSubtype(lhs, reflect(NonZero.class)) && isSubtype(rhs, reflect(Zero.class)) ||
                isSubtype(lhs, reflect(Zero.class)) && isSubtype(rhs, reflect(NonZero.class))) {
                return reflect(NonZero.class);
            }
           
            if (isSubtype(lhs, reflect(Positive.class)) && isSubtype(rhs, reflect(Negative.class)) ||
                isSubtype(lhs, reflect(Negative.class)) && isSubtype(rhs, reflect(Positive.class))) {
                return reflect(NonZero.class);
            }
